...
print "Welcome to the program", sys.argv[1]
...
# data = [contents[28], contents[29], 0x00, 0x00 ]
# bitsPerPixel = struct.unpack("I", bytearray(data))
colorsUsed = 2**((contents[29] << 8) | contents[28])

print "Number of colors used:", colorsUsed

#Create color definition array and init the array of color values
colorIndex = bytearray(colorsUsed)
